...
class FavFoodDialog extends React.Component {
    constructor(props) {
        super(props)
    ...
    removeFavMeal(meal) {
        ...
        var i = localUser.favMeals.findIndex(element => element.id === meal[1])
        if (i > -1) {
    ...
    render() {
        ...
        var tableData = this.props.user ? this.props.user.favMeals : []
        return (
                                ...
                                },
                                {
                                    ...
                                    options: {
                                        ...
                                        customBodyRender: (value, tableMeta, updateValue) => {
                                            return(<IconButton onClick={() => {this.removeFavMeal(tableMeta.rowData)}}><CloseIcon/></IconButton>)
                                        }
                                    }
                                },
                            ]}
...
export default withStyles(styles)(withMensa(withFirebase(withAuthentication(FavFoodDialog))))
